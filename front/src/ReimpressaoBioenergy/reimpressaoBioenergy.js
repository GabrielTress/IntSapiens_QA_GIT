...
import './reimpressaoBioenergy.css';
import { ToastContainer, toast } from 'react-toastify';
import 'react-toastify/dist/ReactToastify.css';
import axios from 'axios';

function ReimprirEtiquetaBioenergy() {
  ...
  const handleReimprimirEtiqueta = async () => {
    ...
    try {
        ...
        'http://192.168.0.250:9002/printEtiquetasBioenergy',
        { wb_numEtq: numEtq },
        { responseType: 'text' }
        );
...
export default ReimprirEtiquetaBioenergy;
